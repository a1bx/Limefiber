  ...
  return (
    <>
      ...
      <div className="bg-white p-4">
        <h1 className="md:text-3xl text-xl font-bold text-center mb-6">Trendy Topics on Home Fiber Technology</h1>
        <img src={Banner3} alt="Blog" className="mb-4 w-full object-cover rounded-lg md:w-screen md:h-[69vh] lg:px-20" />
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="text-lg font-semibold mb-2">Title of the Blog</div>
            ...
            <div className="space-y-4">
              <div className="flex space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">Great blog post!</p>
                </div>
              </div>
              <div className="ml-12 flex space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-800">Thanks, John! I agree.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <label className="flex items-center">
                ...
                />
                <span className="ml-2 text-gray font-Baloo">Remember Email</span>
              </label>
              <button
                type="submit"
                className="bg-green text-white font-semibold py-2 px-4 rounded hover:bg-lightgreen focus:outline-none focus:bg-green"
              >
                Post Comment
              </button>
            </form>
