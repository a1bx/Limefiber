    ...
    return (
        <div className="container mx-auto mb-10">
            <div className="grid md:grid-cols-1">
                ...
                <p className="text-center font-baloo font-normal text-black text-[18px]">
                    Lorem ipsum duis dolor sit amet, consectetur <br/> adipiscing elitvestibulum in pharetra.
                </p>

                <a href="/" className="mx-auto mt-4 flex justify-center items-center w-[162px] h-[49px] bg-[#75a774] rounded-md font-baloo font-normal text-white text-[18px] tracking-[0] leading-[28.5px]">
                    Go Back Home
                </a>
            </div>
        </div>
