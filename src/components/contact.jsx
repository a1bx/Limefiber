...
const contact = () => {
  return (
    <div id="contacts" className="flex flex-col md:flex-row mt-5 relative">
      <div className="flex gap-3 p-4 absolute top-40 md:top-0 mt-20 mb-2 md:mt-0 md:relative md:w-1/2">
        <img
          src={Ellipse16}
          alt=""
          className="hidden sm:block absolute w-3/4 sm:w-[60vh] sm:h- md:left-10 ml-14 top-8 md:top-4"
        />
        <img
          src={Vector9}
          alt=""
      ...
      <div className="md:w-1/2 w-[100%] p-8 md:mt-20 text-center md:text-left mt-4 mb-6 md:ml-8">
        ...
        <div className="md:mt-20 h-[82px] text-black text-opacity-60 text-[14px] font-normal font-Baloo leading-[24.87px] tracking-tight">
