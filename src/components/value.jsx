    ...
    <div className='mt-30 ml-40'>
      ...
      <div className="flex ml-40 gap-4 p-5 mt-8 justify-items-center">
        ...
        <div className="w-[352px] h-[508px] bg-white rounded-[28px]">
          ...
          <p className="text-lg max-w-full mt-10 p-10 text-center">
          ...
          <button className='ml-28 px-4 py-2 justify-self-center rounded-md bg-green hover:bg-green hover:text-white text-white'>Learn More</button>
        </div>
        <div className="" />
      ...
      <div className="grid grid-cols-2 gap-4 p-4 mt-10">
        ...
        <div className="text-[25px] font-medium font-['Baloo Da 2'] leading-loose">Check your Home Fiber Coverage</div>
          <div className="w-[322.05px] h-[131.77px] text-black text-opacity-60 text-xl font-normal font-['Baloo Da 2'] leading-relaxed mt-4">Find out if your area is Home Fiber Ready! To begin click the button below</div>
           
          <div className='flex grid-flow-col px-2 py-2 gap-10 mt-10'>
          <button className='left-0 px-4 py-2 rounded-full border text-green hover:bg-green hover:text-white mt-4'>Get started</button>
